defmodule PhilomenaWeb.Router do
  ...
  scope "/api/v1/json", PhilomenaWeb.Api.Json, as: :api_json do
    ...
    resources "/images", ImageController, only: [:show, :create, :update] do
      resources "/comments", Image.CommentController, only: [:create]
    end
  ...
  scope "/", PhilomenaWeb do
    ...
    resources "/images", ImageController, only: [] do
      ...
      resources "/derpibooru_tags", Image.DerpibooruTagController,
        only: [:create, :update],
        singleton: true
